...
const privacy = () => (
  <>
  <div className="md:pt-0 pt-24 md:pb-0 pb-16 bg-black">
    <div className={styles.wrapper}>
      <div className="bg-[--clip-padding] p-10 backdrop-filter px-6 py-4 backdrop-blur-xl bg-opacity-60 border border-white/10 bg-gradient-to-tl  duration-500 rounded-3xl card-animation hover:border-black/80 via-slate-900 from-black/10 ">
        <h1 className="md:text-5xl text-3xl  title text-bold text-center my-10">
          Privacy Policy
        </h1>
        <div className={styles.policy__para}>
          ...
          <h1 className="md:text-xl  text-3xl my-4">Interpretation and Definitions</h1>

          
          <h1 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Interpretation</h1>
          <p className="text-justify">
          ...
          <h1 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Definitions</h1>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to codeate.in.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Personal Data</strong> is any data that relates to an
            ...
            <li>
              <p>
                <strong>Website</strong> refers to codeate.in, accessible from{" "}
                <a href="https://codeate.in">https://codeate.in</a>.
              </p>
            </li>
            <li>
              <p className="text-justify">
          ...
          <h1 className="md:text-5xl text-2xl py-4">
            Collecting and Using Your Personal Data
          </h1>
          <h2
            className="md:text-3xl text-3xl "
           
          >
            Types of Data Collected
          </h2>
          <h3 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Personal Data</h3>
          <p className="text-justify">
          ...
          <h3 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Usage Data</h3>
          ...
          <h1 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Tracking Technologies and Cookies</h1>
          <p className="text-justify">
          ...
          <h1 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Third Party Privacy Policies </h1>
          <ul>
            <li>
              <p className="text-justify">
            ...
            <li>
              <p className="text-justify">
                <strong>Web Beacon.</strong> Certain sections of our Service and
          ...
          <p className="text-justify">
            ...
            the Privacy Policies website article.
          </p>
          <p>
          ...
          <h1 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Use of Your Personal Data</h1>
          ...
          <h1 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Retention of Your Personal Data</h1>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Business Transactions</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Law enforcement</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Others legal requirements </h2>
          <p>
          ...
          <h1 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Security of Your Personal Data</h1>
          <p>
          ...
          <h1 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">
          ...
          <h1 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Children &apos;s Policy</h1>
          <p>
          ...
          <h1 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Links to Other Websites</h1>
          <p>
          ...
          <h1 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Changes to this Privacy Policy</h1>
          <p>
          ...
          <p>
            ...
            &quot;Last updated&quot; date at the top of thi s Privacy Policy.
          </p>
          <p>
          ...
          <h1 className="text-2xl font-semibold text-pink-500 mt-6 mb-4">Contact Us</h1>
          <p>
          ...
          <ul>
            <li>
              By email:{" "}
              <a href="mailto:By email: contact@codeate.in">
                contact@codeate.in
              </a>
            </li>
            <li>
              By visiting this page on our website:{" "}
              <a href="https://codeate.in/privacy">Privacy</a>
            </li>
          </ul>
        </div>
      </div>
